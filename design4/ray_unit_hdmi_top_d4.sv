// PYNQ-Z1 HDMI wrapper for the ray renderer — DESIGN 4 (bilinear-in-marcher,
// QUARTER-rate core).
//
...
module ray_unit_hdmi_top_d4 (
    ...
    // Heightmap BRAMs — 16 marcher (8 copies) + 2 normal (1 copy),
    // clocked on clk_core.
    //   Marcher: flat [N_STEPS] — each march step owns 1 port, no sharing.
